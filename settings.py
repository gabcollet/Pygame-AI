...
#NPC sprites & setting
NPC_IMG = 'NPC/barman/tile003.png'
NPC_HIT_RECT = pg.Rect(0, 0, 20, 20)
TRAINING_DATA = """The following is a conversation with an Bartender. 
					The bartender is helpful, creative, clever, and very friendly. 
					The Bartender need your help to hunt some cactus to the east.
					\n\nYou: Hello, who are you?
					\nBartender: I am Henry the bartender, can you help me?
					\nYou: I'd like to what can I do?.
					\nBartender:"""	
